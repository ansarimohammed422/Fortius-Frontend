...
//             {error && (
//               <div className="mt-4 p-3 w-[700px] rounded-lg bg-red-100 text-red-600 text-center">
//                 {error}
//               </div>
//             )}
//           </div>
...
const Register = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[url('./assets/New_teal.jpg')] bg-no-repeat bg-cover p-4">
      <div className="bg-teal-400/30 border-2 border-blue-950 backdrop-blur-lg p-8 sm:p-12 md:p-20 rounded-lg shadow-xl w-full max-w-lg">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-blue-950 text-center mb-6 drop-shadow-lg">
          Register
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="mt-4">
            <button
              type="submit"
              className="w-full sm:w-fit text-xl font-bold bg-transparent hover:bg-blue-950 border border-blue-950 text-blue-950 hover:text-teal-400 py-2 px-5 rounded-lg transition-all ease-linear duration-300"
            >
              Register
            </button>
          </div>
          ...
          {error && (
            <div className="mt-4 p-3 w-full sm:w-[500px] rounded-lg bg-red-100 text-red-600 text-center">
              {error}
            </div>
          )}
        </form>

        <div className="p-3 text-center text-sm sm:text-base">
          Already a user:{" "}
          <Link
            to="/login"
            className="hover:text-blue-900 hover:underline font-black"
