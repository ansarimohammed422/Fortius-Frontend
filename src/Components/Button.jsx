...
const Button = (props) => {
  const defaultClass = `
    bg-teal-300 px-4 sm:px-5 py-2 text-base sm:text-2xl
    cfont-nunito w-fit text-blue-950 rounded-lg shadow-md border border-blue-950
    hover:bg-blue-950 hover:border hover:border-teal-400 hover:text-teal-400
...
const MyLinks = (props) => {
  const defaultClass = `
    text-base sm:text-3xl font-black
    hover:text-blue-950 transition-all ease-linear duration-300 text-teal-400
  `;
