    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[url('./assets/New_teal.jpg')] bg-no-repeat bg-cover">
            <div className="bg-teal-400/30 border-2 border-blue-950 backdrop-blur-lg p-10 rounded-lg shadow-xl w-1/4">
                <h2 className="text-5xl font-black text-blue-950 text-center mb-6 drop-shadow-lg">Welcome Back</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {error && (<div className="mt-4 p-3 rounded-lg bg-red-100 text-red-600 text-center">
                        {error}
                    </div>)}
                </form>
                <div className="pt-3 text-center" >New user ? <Link to="/register" className="hover:text-blue-900 hover:underline font-black" >register</Link> </div>
                <hr className="w-1/2 mx-auto" />
                <div className="pb-3 text-center" >Forget Password ? <Link to="/forgot-password" className="hover:text-blue-900 hover:underline font-black" >reset</Link> </div>
