    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={` p-0 m-0 w-fit h-fit rounded-full border-2 border-transparent animate-border
                    ${
                      isScrolled
                        ? "text-olive-500 hover:text-blue-950 [background:linear-gradient(45deg,#ffffff,theme(colors.white)_50%,#ffffff)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.olive.500)_80%,_theme(colors.blue.950)_86%,_theme(colors.blue.950)_90%,_theme(colors.blue.950)_94%,_theme(colors.blue.950))_border-box]"
                        : "text-blue-950 hover:text-blue-950/70 [background:linear-gradient(45deg,#7c8442,theme(colors.olive.300)_50%,#7c8442)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.blue.950)_80%,_theme(colors.olive.500)_86%,_theme(colors.olive.500)_90%,_theme(colors.olive.500)_94%,_theme(colors.olive.500))_border-box]"
                    }
