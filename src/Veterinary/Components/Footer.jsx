...
const Footer = () => {
  return (
    <footer className="bg-olive-50 border-t border-olive-200">
      <div className="container mx-auto px-6 py-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-center text-blue-950 max-w-md">
            Fortius Veterinary Clinic is dedicated to compassionate, expert care
            for your beloved pets. From diagnostics to treatment, your animal's
          ...
          <ul className="flex flex-wrap justify-center gap-8 text-base">
            <li>
              <MyLinks
                path="/vet/About"
                LName="About Us"
                customClass="!text-blue-950 text-base hover:!text-olive-500 font-medium transition-all ease-linear duration-300"
              />
            </li>
            <li>
              <MyLinks
        ...
        <ul className="mt-12 flex justify-center gap-6 md:gap-8">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="text-blue-950 hover:text-olive-500 transition-all ease-linear duration-300"
            >
      ...
      <div className="w-full bg-olive-500 text-olive-200 p-5 text-center text-2xl font-extrabold">
        &copy; 2025 Fortius Veterinary Clinic
      </div>
    </footer>
  );
};
