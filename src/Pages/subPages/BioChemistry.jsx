...
const Biochemistry = () => {
  ...
  return (
    <div className="bg-white text-gray-800">
      {/* Hero Section */}
      <section className="relative bg-[url('./assets/New_teal.jpg')] bg-cover bg-center text-white h-[80vh] sm:h-[90vh] md:h-screen flex items-center justify-center">
        <div className="text-center bg-teal-400/30 backdrop-blur-lg rounded-xl p-8 sm:p-16 md:p-20 border-2 border-blue-950 shadow-lg max-w-[95%] sm:max-w-4xl">
          <h1 className="text-5xl sm:text-7xl md:text-9xl font-extrabold text-blue-950">
            Biochemistry Services
          </h1>
          <p className="mt-4 mb-6 sm:mb-10 text-lg sm:text-xl md:text-2xl text-blue-950">
            Dive into the molecular world of life with advanced biochemistry
            testing.
          </p>
          <div className="mt-4 sm:mt-6">
            <MyLinks
              LName="Book Now"
              path="/Appointment"
              customClass="text-lg sm:text-xl bg-blue-950 border-2 shadow-none hover:shadow-xl hover:border-none hover:!text-blue-950 border-teal-400 px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-transparent hover:text-teal-400 transition-all duration-300"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-12 sm:py-16 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-12">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-950 mb-4">
                What is Biochemistry?
              </h2>
              <p className="text-base sm:text-lg md:text-lg text-blue-950/70 mb-4 sm:mb-6">
                Biochemistry is the study of the chemical processes within
                living organisms. It combines biology and chemistry to explore
                the molecular mechanisms of life.
              </p>
              <button
                onClick={() => setShowMore(!showMore)}
                className={`font-bold px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg text-base sm:text-xl border-2 ${
                  showMore
                    ? "bg-blue-950 text-teal-400 hover:bg-teal-400 hover:text-blue-950 hover:border-teal-400"
                    : "bg-teal-400 text-blue-950 border-blue-950 hover:bg-blue-950 hover:text-teal-400"
                } transition-all ease-linear duration-500`}
            ...
            <div className="bg-[url('./assets/biochemistry.jpg')] bg-cover bg-center h-64 sm:h-80 md:h-96 w-full rounded-lg shadow-lg"></div>
          </div>
          {/* Hidden Content Section */}
          <div className="mt-6 sm:mt-8 md:mt-12">
            ...
            >
              <div className="p-4 sm:p-6 md:p-6 bg-teal-50 rounded-lg shadow-md border border-blue-950">
                <h3 className="text-2xl sm:text-3xl md:text-3xl font-bold text-blue-950 mb-2 sm:mb-4">
                  The Role of Biochemistry in Medicine
                </h3>
                <p className="text-base sm:text-lg md:text-lg text-blue-950/70 mb-2 sm:mb-4">
                  Biochemistry is essential in understanding diseases at the
                  molecular level. By analyzing enzymes, proteins, and DNA,
                  biochemists can identify abnormalities that cause illnesses.
                </p>
                <p className="text-base sm:text-lg md:text-lg text-blue-950/70 mb-2 sm:mb-4">
                  It also plays a vital role in drug development, metabolic
                  studies, and clinical diagnostics, paving the way for
                  innovative treatments.
                </p>
                <p className="text-base sm:text-lg md:text-lg text-blue-950/70">
                  Embrace the power of biochemistry to decode the complexities
                  of life and advance healthcare solutions.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Expertise Section */}
      <section className="bg-teal-50 py-12 sm:py-16 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 md:px-6 text-center">
            ...
            {[
              {
                title: "Enzyme Analysis",
                description:
                  "Detect enzyme activity and related disorders with precision.",
              },
              {
                title: "Metabolic Profiling",
                description:
                  "Comprehensive analysis of metabolic pathways and processes.",
              },
              {
                title: "Protein Characterization",
                description:
                  "Study protein structures and functions for advanced diagnostics.",
              },
            ].map((item, index) => (
              <div
                key={index}
                className="bg-white p-4 sm:p-6 md:p-6 rounded-lg shadow-md border border-teal-300 hover:shadow-lg transition-all"
              >
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-teal-50 p-4 sm:p-6 md:p-6 rounded-xl shadow-md border border-teal-300 hover:bg-teal-100 hover:scale-105 transform transition-all ease-linear duration-500"
              >
                <p className="text-base sm:text-lg md:text-xl font-medium text-blue-950">
                  {test}
                </p>
              </div>
            ))}
