...
const Microbiology = () => {
  return (
    <div className="bg-white text-gray-800">
      {/* Hero Section */}
      <section className="relative bg-[url('./assets/New_teal.jpg')] bg-cover bg-no-repeat bg-center text-white h-screen flex items-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 py-12 text-center">
          <div className="bg-teal-400/30 filter backdrop-blur-lg rounded-xl py-12 sm:py-20 border-2 border-blue-950 shadow-lg">
            ...
            <div className="mt-4 sm:mt-6">
              <MyLinks
                LName="Book Now"
                path="/Appointment"
                customClass="text-lg sm:text-xl md:text-2xl bg-blue-950 border-2 shadow-none hover:shadow-xl border-blue-950 hover:border-none px-4 sm:px-5 py-2 sm:py-3 rounded-lg hover:bg-transparent transition-all duration-300"
              />
            </div>
          </div>
        </div>
      ...
      <section className="bg-teal-50 py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 text-blue-950">
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-12">
            <div className="lg:w-1/2 p-4 sm:p-6 lg:p-6">
            ...
            <div className="lg:w-1/2 bg-[url('./assets/MicroBiology.jpg')] bg-cover bg-center h-64 sm:h-80 md:h-96 lg:h-96 rounded-lg shadow-lg"></div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="p-6 bg-teal-50 rounded-lg shadow-lg border border-blue-950">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 text-blue-950">
                Diagnostic Microbiology
              </h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 text-blue-950">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <div
                key={index}
                className="p-4 sm:p-6 bg-white rounded-lg shadow-md hover:bg-teal-100 hover:scale-105 transform transition duration-300 ease-in-out border-2 border-teal-50 hover:border-teal-400"
              >
