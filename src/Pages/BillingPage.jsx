...
//     }
//     axios
//       .get(`${API_URL}/api/billing/${appointmentId}/`)
//       .then((response) => {
...
//         <div
//           ref={billRef}
//           className="max-w-2xl w-full bg-teal-50 p-8 rounded-lg shadow-lg border border-gray-300"
//         >
//           {/* Bill Header */}
//           <div className="text-center mb-6">
//             <h1 className="text-3xl font-bold text-blue-950">
//               Fortius Diagnostic Center
//             </h1>
...
//             </p>
//             <p>
//               <strong>Email:</strong> {bill.user_email}
//             </p>
//             <p>
//               <strong>Phone:</strong> {bill.user_phone}
//             </p>
//             <p>
//               <strong>Appointment ID:</strong> {bill.appointment_id}
//             </p>
//             <p>
//               <strong>Generated At:</strong> {bill.generated_at}
//             </p>
//           </div>
...
//                   <th className="border border-teal-400 px-4 py-2 text-teal-400 text-left">
//                     Test Name
//                   </th>
//                   <th className="border border-teal-400 px-4 py-2 text-teal-400 text-left">
//                     Price (₹)
...
//                   <tr
//                     key={index}
//                     className="text-gray-800 border-b border-teal-400"
//                   >
//                     <td className="px-4 py-2 border border-teal-400">
//                       {test.name}
//                     </td>
//                     <td className="px-4 py-2 border border-teal-400">
//                       ₹{test.price}
...
//               </h3>
//               <p className="text-xl font-bold text-gray-800">
//                 ₹Rs.{offerPrice == null ? null : offerPrice}
//               </p>
//             </div>
//           </div>
...
const BillingPage = () => {
  ...
  return (
    <div className="flex justify-center items-start pt-20 sm:pt-32 pb-10 min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-20">
      {loading ? (
        <p className="text-blue-950 text-lg sm:text-xl">
          Loading bill details...
        </p>
      ) : (
        <div
          ref={billRef}
          className="max-w-2xl sm:max-w-3xl w-full bg-teal-50 p-6 sm:p-8 md:p-10 rounded-lg shadow-lg border border-gray-300"
        >
          {/* Bill Header */}
          <div className="text-center mb-6">
            ...
            {offerPrice && (
              <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 mt-1">
                Packaged Tests
              </h1>
            )}
          </div>
          ...
          {/* Patient Details */}
          <div className="mb-6 text-sm sm:text-base md:text-lg">
            <p>
              <strong>Patient Name:</strong> {bill.patient_name}
            </p>
            <p>
          ...
          <div className="mb-6 overflow-x-auto">
            <h3 className="text-base sm:text-lg md:text-xl font-semibold text-blue-950 mb-2">
              Test Details
            </h3>
            <table className="min-w-full border-collapse border border-gray-300 text-sm sm:text-base md:text-base">
              <thead>
                <tr className="bg-blue-950 text-white">
                  <th className="border border-teal-400 px-2 sm:px-4 py-1 sm:py-2 text-left">
                    Test Name
                  </th>
                  <th className="border border-teal-400 px-2 sm:px-4 py-1 sm:py-2 text-left">
                    Price (₹)
              ...
              <tbody>
                {bill.tests.map((test, index) => (
                  <tr
                    ...
                    className="text-gray-800 border-b border-teal-400"
                  >
                    <td className="px-2 sm:px-4 py-1 sm:py-2 border border-teal-400">
                      {test.name}
                    </td>
                    <td className="px-2 sm:px-4 py-1 sm:py-2 border border-teal-400">
                      ₹{test.price}
          ...
          <div className="flex justify-center mt-6">
            <button
              onClick={handlePrint}
              className="bg-blue-950 text-teal-400 px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-semibold hover:bg-teal-400 hover:text-blue-950 transition-colors duration-300"
            >
              Download PDF
            </button>
          </div>
