...
const Appointment = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 py-10">
      <TestSelection.Provider value={{ selectedTest, setSelectedTest }}>
        {/* Header Section */}
        <div className="max-w-7xl flex justify-center items-center mx-auto">
          <div className="w-full border-4 border-transparent animate-border rounded-3xl overflow-hidden [background:linear-gradient(45deg,#F0FDFA,theme(colors.teal.50)_50%,#F0FDFA)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.teal.400)_80%,_theme(colors.teal.500)_86%,_theme(colors.teal.600)_90%,_theme(colors.teal.700)_94%,_theme(colors.blue.950))_border-box]">
            <div className="overflow-hidden bg-[url('./assets/New_teal.jpg')] bg-cover bg-no-repeat text-blue-950 text-center shadow-xl shadow-gray-300 rounded-3xl">
              {alertMessage && (
                <div
                  className={`fixed top-5 z-10 left-1/2 transform -translate-x-1/2 w-11/12 sm:w-3/4 max-w-lg px-4 py-3 rounded-lg text-white text-center ${
                    alertType === "success" ? "bg-green-500" : "bg-red-500"
                  }`}
                >
                  {alertMessage}
              ...
              <div className="p-6 sm:p-10 md:p-16 lg:p-20 bg-teal-400/30 backdrop-blur-lg">
                <h1 className="text-2xl sm:text-4xl md:text-6xl lg:text-8xl font-bold text-blue-950">
                  Book an Appointment
                </h1>
                <p className="mt-4 text-base sm:text-lg md:text-xl text-blue-950">
                  Get an appointment at{" "}
                  <span className="ml-1 font-extrabold">Fortius</span>
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Search Section */}
        <div className="mx-auto grid max-w-screen-lg px-2 sm:px-6 pb-10 md:pb-20">
          <div className="my-6 sm:my-10 flex flex-col gap-4 sm:gap-6">
            <p className="text-lg sm:text-2xl font-extrabold text-blue-950">
              Search for a Tests:
            </p>
            <SearchBar alltests={tests} offerPrice={pkgprice} />
          </div>
          ...
          {/* Form Section */}
          <div className="mb-10">
            <p className="text-lg sm:text-2xl my-4 sm:my-5 font-extrabold text-blue-950">
              Fill in Details
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Date */}
              <div className="flex flex-col gap-2 text-sm sm:text-base md:text-lg lg:text-xl text-blue-950">
                <label>Select a date</label>
                <input
                  type="date"
                  value={selectedDate}
                  onChange={(e) => setSelectedDate(e.target.value)}
                  className="block w-full rounded-full px-4 py-2 sm:py-3 text-base sm:text-lg border border-teal-400 bg-white text-blue-950 focus:ring focus:ring-teal-400 focus:shadow-md focus:outline-none transition-all"
                  required
                />
              </div>
              ...
              <div className="flex flex-col gap-2 text-sm sm:text-base md:text-lg lg:text-xl text-blue-950">
                ...
                <input
                  ...
                  className="px-4 py-2 w-full bg-white rounded-full border border-teal-400 focus:ring focus:ring-teal-400 focus:shadow-md focus:outline-none transition-all"
                  placeholder="Enter Name"
                />
              </div>
          ...
          {/* Home Sample */}
          <div className="mb-6 text-base sm:text-lg md:text-xl">
            <label className="font-bold text-blue-950 flex items-center gap-3 sm:gap-4 cursor-pointer">
              <div className="relative">
                <input
                  type="checkbox"
                  checked={homeSample}
                  ...
                  className="sr-only peer"
                />
                <div className="w-10 sm:w-12 h-5 sm:h-6 bg-blue-950 rounded-full peer-checked:bg-teal-500 transition-all"></div>
                <div className="absolute top-0.5 left-0.5 w-4 h-4 sm:w-5 sm:h-5 bg-teal-400 rounded-full shadow-md peer-checked:translate-x-5 sm:peer-checked:translate-x-6 peer-checked:bg-blue-950 transition-all"></div>
              </div>
              <h1 className="text-lg sm:text-xl md:text-2xl font-extrabold text-blue-950">
                Request Home Sample Collection
              </h1>
            </label>
            {homeSample && (
              <input
                ...
                className="mt-3 px-4 py-2 w-full bg-white rounded-lg border border-teal-400 focus:ring focus:ring-teal-400 focus:shadow-md focus:outline-none transition-all"
              />
            )}
          </div>
          ...
          <Button
            bname="Book Now"
            customClass="w-full sm:w-auto my-6 sm:my-10"
            bifunc={handleSubmit}
          />
        </div>
      </TestSelection.Provider>
