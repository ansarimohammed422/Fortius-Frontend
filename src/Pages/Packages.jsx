...
const PackagesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-teal-50 text-blue-950 pt-36 px-4 sm:px-6 lg:px-8">
      <h1 className="text-4xl sm:text-5xl font-bold border-b-2 border-teal-400 pb-2 mb-10 text-center">
        Our Test Packages
      </h1>
      ...
      <div className="space-y-6">
        {packages.map((pkg) => {
          ...
          return (
            <motion.div
              key={pkg.id}
              className={`w-full rounded-xl shadow-lg p-6 sm:p-8 border transition-colors duration-300 cursor-pointer
                ${isExpanded ? "bg-teal-100 border-teal-300" : "bg-white border-gray-200"}
            ...
            >
              ...
              {/* Price Info */}
              <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 mb-2 gap-1 sm:gap-0">
                <p className="text-lg">
                  Offer Price:{" "}
                  <span className="font-medium text-blue-800">
                    ₹{pkg.offer_price}
                ...
                {isExpanded && (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mt-2">
                      <button
                        onClick={() => handleBook(pkg.tests, pkg)}
                        className="flex-1 bg-blue-950 text-white py-2 rounded-lg hover:bg-blue-900 transition"
                      >
                        Book Package
                      </button>
                      <button
                        onClick={() => toggleExpand(pkg.id)}
                        className="flex-1 border border-teal-400 text-teal-400 py-2 rounded-lg hover:bg-teal-100 transition"
                      >
                        Close
                      </button>
                    </div>
